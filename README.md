...
<div style="display: flex; gap: 1rem; align-items: flex-start; width: clamp(600px, 90%, 1000px); height: 900px; padding-bottom: 2rem;">
  ...
  <div style="display: flex; flex-direction: column; gap: 1rem; width: 70%">
  ...
  <figure style="margin: 0; height: 50%; text-align: center;">
    ...
    <img src="previews/tablet-preview.jpeg" alt="Desktop Preview" style="width: 90%;" />
  </figure>
  </div>
</div>
